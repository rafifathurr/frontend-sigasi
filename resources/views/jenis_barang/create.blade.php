...
@section('content')
    <div class="container-fluid px-0">
        <h4 class="fw-bold py-3"><span class="text-muted fw-light">Jenis Barang /</span> Tambah Jenis Barang</h4>
        <div class="card shadow-sm border-0 w-100">
            <form action="{{ route('jenis-barang.store') }}" method="POST" id="form-submit">
                @csrf
                <div class="card-body">
