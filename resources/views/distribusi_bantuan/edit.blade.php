                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-lg-4">
                            ...
                            <input type="date" class="form-control" name="tanggalDistribusi"
                                value="{{ date('Y-m-d', strtotime($data->distribusi_bantuan->TanggalDistribusi)) }}"
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="productTable">
                                    ...
                                    <tbody id="productBody">
                                        ...
                                        @foreach ($data->distribusi_bantuan->distribusi_bantuan_items as $item)
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden"
                                                        name="barang[{{ $loop->iteration - 1 }}][IDBarang]"
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="6" align="right" class="fw-bold">Total Keseluruhan Harga
                                            </td>
                                            <td align="right" class="fw-bold">Rp.<span
                                                    id="totalHargaTxt">{{ number_format($total, 0, ',', '.') }}</span>
                                            </td>
                                            <td></td>
                                        </tr>
                                    </tfoot>
        ...
        <script>
            ...
            $('#idBantuan').on('change', function() {
                ...
                if (idBantuan) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.length > 0) {
                                ...
                                const $row = $('<tr>');
                                $row.append($(
                                    '<td colspan="7" align="center">Tidak terdapat data bantuan.</td>'
                                ));
                                $('#productBody').append($row);
                            }
                        },
                    ...
                    $('#productBody').empty();
                    $row.append($(
                        '<td colspan="7" align="center">Harap pilih bantuan terlebih dahulu.</td>'
                    ));
                }
            });
            ...
            $('#idPosko').val({{ $data->distribusi_bantuan->IDPosko }}).trigger('change');
        </script>
    @endpush
@endsection
