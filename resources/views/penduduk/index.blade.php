...
@section('content')
    <div class="container-fluid px-0">
        <h4 class="fw-bold py-3"><span class="text-muted fw-light">Beranda /</span> Daftar Penduduk</h4>
        <div class="card shadow-sm border-0 w-100">
            <div class="card-body">
                <div class="row pt-2 pb-4 align-items-end">
                    <div class="col-lg-3">
                        <a href="{{ route('penduduk.create') }}" class="btn btn-primary ms-auto"><i
